...
module AXI4Xbar(
  ...
  wire        in_0_r_valid;
  wire        _portsWOI_in_0_w_ready_T_1;
  wire        _portsAWOI_in_0_aw_ready_T_1;
  ...
  wire [15:0] _GEN =
    {{(arFIFOMap_15_count == 3'h0 | arFIFOMap_15_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_15_T_22},
     {(arFIFOMap_14_count == 3'h0 | arFIFOMap_14_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_14_T_22},
     {(arFIFOMap_13_count == 3'h0 | arFIFOMap_13_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_13_T_22},
     {(arFIFOMap_12_count == 3'h0 | arFIFOMap_12_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_12_T_22},
     {(arFIFOMap_11_count == 3'h0 | arFIFOMap_11_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_11_T_22},
     {(arFIFOMap_10_count == 3'h0 | arFIFOMap_10_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_10_T_22},
     {(arFIFOMap_9_count == 3'h0 | arFIFOMap_9_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_9_T_22},
     {(arFIFOMap_8_count == 3'h0 | arFIFOMap_8_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_8_T_22},
     {(arFIFOMap_7_count == 3'h0 | arFIFOMap_7_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_7_T_22},
     {(arFIFOMap_6_count == 3'h0 | arFIFOMap_6_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_6_T_22},
     {(arFIFOMap_5_count == 3'h0 | arFIFOMap_5_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_5_T_22},
     {(arFIFOMap_4_count == 3'h0 | arFIFOMap_4_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_4_T_22},
     {(arFIFOMap_3_count == 3'h0 | arFIFOMap_3_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_3_T_22},
     {(arFIFOMap_2_count == 3'h0 | arFIFOMap_2_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_2_T_22},
     {(arFIFOMap_1_count == 3'h0 | arFIFOMap_1_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_1_T_22},
     {(arFIFOMap_0_count == 3'h0 | arFIFOMap_0_last == auto_in_ar_bits_addr[28])
        & _arFIFOMap_0_T_22}};
  ...
  wire [15:0] _GEN_0 =
    {{(awFIFOMap_15_count == 3'h0 | awFIFOMap_15_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_15_T_21},
     {(awFIFOMap_14_count == 3'h0 | awFIFOMap_14_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_14_T_21},
     {(awFIFOMap_13_count == 3'h0 | awFIFOMap_13_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_13_T_21},
     {(awFIFOMap_12_count == 3'h0 | awFIFOMap_12_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_12_T_21},
     {(awFIFOMap_11_count == 3'h0 | awFIFOMap_11_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_11_T_21},
     {(awFIFOMap_10_count == 3'h0 | awFIFOMap_10_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_10_T_21},
     {(awFIFOMap_9_count == 3'h0 | awFIFOMap_9_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_9_T_21},
     {(awFIFOMap_8_count == 3'h0 | awFIFOMap_8_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_8_T_21},
     {(awFIFOMap_7_count == 3'h0 | awFIFOMap_7_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_7_T_21},
     {(awFIFOMap_6_count == 3'h0 | awFIFOMap_6_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_6_T_21},
     {(awFIFOMap_5_count == 3'h0 | awFIFOMap_5_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_5_T_21},
     {(awFIFOMap_4_count == 3'h0 | awFIFOMap_4_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_4_T_21},
     {(awFIFOMap_3_count == 3'h0 | awFIFOMap_3_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_3_T_21},
     {(awFIFOMap_2_count == 3'h0 | awFIFOMap_2_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_2_T_21},
     {(awFIFOMap_1_count == 3'h0 | awFIFOMap_1_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_1_T_21},
     {(awFIFOMap_0_count == 3'h0 | awFIFOMap_0_last == auto_in_aw_bits_addr[28])
        & _awFIFOMap_0_T_21}};
  wire        in_0_aw_valid =
    auto_in_aw_valid & _nodeIn_aw_ready_T & _GEN_0[auto_in_aw_bits_id];
  assign nodeIn_aw_ready =
    _portsAWOI_in_0_aw_ready_T_1 & _nodeIn_aw_ready_T & _GEN_0[auto_in_aw_bits_id];
  ...
  assign _portsAROI_in_0_ar_ready_T_2 =
    ~(auto_in_ar_bits_addr[28]) & auto_out_0_ar_ready | auto_in_ar_bits_addr[28]
    & auto_out_1_ar_ready;
  assign _portsAWOI_in_0_aw_ready_T_1 = auto_in_aw_bits_addr[28] & auto_out_1_aw_ready;
  assign _portsWOI_in_0_w_ready_T_1 = _awIn_0_io_deq_bits[1] & auto_out_1_w_ready;
  reg         idle_2;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      latched <=
        ~(_portsAWOI_in_0_aw_ready_T_1 & in_0_aw_valid)
    ...
    if (_arFIFOMap_0_T_2)
      arFIFOMap_0_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_0_T_2)
      awFIFOMap_0_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_1_T_2)
      arFIFOMap_1_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_1_T_2)
      awFIFOMap_1_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_2_T_2)
      arFIFOMap_2_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_2_T_2)
      awFIFOMap_2_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_3_T_2)
      arFIFOMap_3_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_3_T_2)
      awFIFOMap_3_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_4_T_2)
      arFIFOMap_4_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_4_T_2)
      awFIFOMap_4_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_5_T_2)
      arFIFOMap_5_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_5_T_2)
      awFIFOMap_5_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_6_T_2)
      arFIFOMap_6_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_6_T_2)
      awFIFOMap_6_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_7_T_2)
      arFIFOMap_7_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_7_T_2)
      awFIFOMap_7_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_8_T_2)
      arFIFOMap_8_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_8_T_2)
      awFIFOMap_8_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_9_T_2)
      arFIFOMap_9_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_9_T_2)
      awFIFOMap_9_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_10_T_2)
      arFIFOMap_10_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_10_T_2)
      awFIFOMap_10_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_11_T_2)
      arFIFOMap_11_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_11_T_2)
      awFIFOMap_11_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_12_T_2)
      arFIFOMap_12_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_12_T_2)
      awFIFOMap_12_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_13_T_2)
      arFIFOMap_13_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_13_T_2)
      awFIFOMap_13_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_14_T_2)
      arFIFOMap_14_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_14_T_2)
      awFIFOMap_14_last <= auto_in_aw_bits_addr[28];
    if (_arFIFOMap_15_T_2)
      arFIFOMap_15_last <= auto_in_ar_bits_addr[28];
    if (_awFIFOMap_15_T_2)
      awFIFOMap_15_last <= auto_in_aw_bits_addr[28];
  end // always @(posedge)
  Queue2_UInt2 awIn_0 (
    .clock        (clock),
    .reset        (reset),
    ...
    .io_enq_bits  ({auto_in_aw_bits_addr[28], ~(auto_in_aw_bits_addr[28])}),
    .io_deq_ready (auto_in_w_valid & auto_in_w_bits_last & _portsWOI_in_0_w_ready_T_1),
    .io_deq_valid (_awIn_0_io_deq_valid),
    .io_deq_bits  (_awIn_0_io_deq_bits)
  );
  assign auto_in_aw_ready = nodeIn_aw_ready;
  assign auto_in_w_ready = _portsWOI_in_0_w_ready_T_1 & _awIn_0_io_deq_valid;
  ...
  assign auto_out_1_aw_valid = in_0_aw_valid & auto_in_aw_bits_addr[28];
  ...
  assign auto_out_1_ar_valid = in_0_ar_valid & auto_in_ar_bits_addr[28];
  ...
  assign auto_out_0_aw_valid = in_0_aw_valid & ~(auto_in_aw_bits_addr[28]);
  ...
  assign auto_out_0_ar_valid = in_0_ar_valid & ~(auto_in_ar_bits_addr[28]);
