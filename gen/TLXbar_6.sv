...
module TLXbar_6(
  ...
  wire       _portsAOI_in_0_a_ready_T_2 =
    ~(auto_in_a_bits_address[14]) & auto_out_0_a_ready | auto_in_a_bits_address[14]
    & auto_out_1_a_ready;
  reg        beatsLeft;
  ...
  wire       in_0_d_valid =
    beatsLeft
      ...
      : _in_0_d_valid_T;
  wire [3:0] _in_0_d_bits_T_14 =
    (muxState_0 ? auto_out_0_d_bits_source : 4'h0)
    | (muxState_1 ? auto_out_1_d_bits_source : 4'h0);
  wire [1:0] _in_0_d_bits_T_17 =
    (muxState_0 ? auto_out_0_d_bits_size : 2'h0)
    | (muxState_1 ? auto_out_1_d_bits_size : 2'h0);
  wire [2:0] _in_0_d_bits_T_23 =
  ...
  TLMonitor_19 monitor (
    ...
    .io_in_d_bits_opcode  (_in_0_d_bits_T_23),
    .io_in_d_bits_size    (_in_0_d_bits_T_17),
    .io_in_d_bits_source  (_in_0_d_bits_T_14)
  );
  assign auto_in_a_ready = _portsAOI_in_0_a_ready_T_2;
  assign auto_in_d_valid = in_0_d_valid;
  assign auto_in_d_bits_opcode = _in_0_d_bits_T_23;
  assign auto_in_d_bits_size = _in_0_d_bits_T_17;
  assign auto_in_d_bits_source = _in_0_d_bits_T_14;
  assign auto_in_d_bits_data =
    (muxState_0 ? auto_out_0_d_bits_data : 64'h0)
    | (muxState_1 ? auto_out_1_d_bits_data : 64'h0);
  assign auto_out_1_a_valid = auto_in_a_valid & auto_in_a_bits_address[14];
  ...
  assign auto_out_0_a_valid = auto_in_a_valid & ~(auto_in_a_bits_address[14]);
