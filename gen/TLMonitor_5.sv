...
module TLMonitor_5(
  ...
  `ifndef SYNTHESIS
    ...
    wire [191:0]    _GEN_23 = {184'h0, io_in_d_bits_source, 2'h0};
    wire [191:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> _GEN_23;
    ...
    wire [47:0]     _GEN_32 = inflight >> _GEN_26;
    wire [191:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_23;
    wire [63:0]     _d_clr_wo_ready_T = 64'h1 << _GEN_1;
    wire [47:0]     _GEN_33 = inflight_1 >> _GEN_26;
    wire [191:0]    _c_size_lookup_T_1 = inflight_sizes_1 >> _GEN_23;
    always @(posedge clock) begin
      ...
      if (_GEN_24 & ~a_first_counter_1 & io_in_a_valid
      ...
      if (~reset
          & ~(a_set_wo_ready != (_GEN_25 ? _d_clr_wo_ready_T[47:0] : 48'h0)
  ...
  wire [526:0] _d_sizes_clr_T_11 = 527'hF << _GEN_34;
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inflight_1 <= inflight_1 & ~(_GEN_36 ? _d_clr_T_1[47:0] : 48'h0);
      inflight_sizes_1 <=
        inflight_sizes_1 & ~(_GEN_36 ? _d_sizes_clr_T_11[191:0] : 192'h0);
      d_first_counter_2 <=
