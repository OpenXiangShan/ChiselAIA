...
class IMSIC(Subgraph):
  ...
  def __init__(self):
    ...
    self.add_edge(Edge(self.intFiles[0].ireg, self.mireg, dir="back"))
    self.sireg = Node("imsic_sireg", label="sireg[4B]")
    self.add_node(self.sireg)
    self.add_edge(Edge(self.intFiles[1].ireg, self.sireg, dir="back"))
    self.vsireg = Node("imsic_vsireg", label="vsireg[4B]", height=1.2)
    self.add_node(self.vsireg)
    self.add_edge(Edge(self.intFiles[2].ireg, self.vsireg, dir="back"))
    self.add_edge(Edge(self.intFiles[3].ireg, self.vsireg, dir="back"))
...
graph.add_edge(Edge(imsic.mireg, hart, dir="back"))
graph.add_edge(Edge(imsic.sireg, hart, dir="back"))
graph.add_edge(Edge(imsic.vsireg, hart, dir="back"))
